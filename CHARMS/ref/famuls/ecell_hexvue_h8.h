...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_HEXVUE_H8_H
# define ECELL_HEXVUE_H8_H

#include "ecell_hexvue.h"
#include "gcell_solid_h8.h"

template <int NUM_COMPONENTS>
class ECELL_HEXVUE_H8 : public ECELL_HEXVUE<NUM_COMPONENTS> {
...
make (GCELL *gcell)
{
  return (new ECELL_HEXVUE_H8<NUM_COMPONENTS> (gcell));
}

template <int NUM_COMPONENTS>
bool
ECELL_HEXVUE_H8<NUM_COMPONENTS>::register_make_func ()
{
