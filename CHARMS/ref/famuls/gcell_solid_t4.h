...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef GCELL_SOLID_T4_H
# define GCELL_SOLID_T4_H
...
class GCELL_SOLID_T4 : public GCELL {
 ...
 public: // class members
  ...
  static const sizet NDETAILFENS = 6; // mid-edge nodes
  ...
  static const int _child_map[NCHILDREN][4];

  static const int _child_map_reflected[NCHILDREN][4];
 ...
 public: // object functions ////////////////////////////////////////
  ...
  /**
   */
  GCELL_SOLID_T4 (vector <FEN *> fens);
  ~GCELL_SOLID_T4 () { }
  ...
  */
  ...
  GraphicObj *make_elixir_obj () {
    ...
    GraphicObj *go = CreateTetra (points);
    return go;
  }
 ...
 private: // object data ////////////////////////////////////////////
  ...
  CONN_SOLID_4    _conn;
  GCELL_SOLID_T4 *_parent;
  GCELL_SOLID_T4 *_child[NCHILDREN];
  bool            _is_reflection;

 private: // object auxiliary ///////////////////////////////////////

  void eval_ns (GCELL_SOLID_T4 *child, EVALPT *evalpt,
                double xi, double eta, double theta, double B[3][3]);
#if 0
  void check_is_inside_child (double xi, double eta, double theta, GCELL_SOLID_T4 *child,
                              double child_xi, double child_eta, double child_theta);
  void check_is_inside_parent (double xi, double eta, double theta, GCELL_SOLID_T4 *parent,
