...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef GCELL_SOLID_H8_H
# define GCELL_SOLID_H8_H

#include "fen.h"
#include "gcell.h"
#include "g3d.h"

class GCELL_SOLID_H8 : public GCELL {
 ...
 public: // class members
  ...
  static const sizet NDETAILFENS = 19; // mid-edge nodes, mid-face nodes, mid-volume node
 ...
 public: // object functions ////////////////////////////////////////
  ...
  /**
   */
  GCELL_SOLID_H8 (vector <FEN *> fens);
  ~GCELL_SOLID_H8 () { }
...
//  std::set <FEN *> complete_refinement_set (FEN *fen_of_bfun_to_refine);
 ...
 private: // object data ////////////////////////////////////////////
  ...
  CONN_SOLID_8    _conn;
  GCELL_SOLID_H8 *_parent;
  GCELL_SOLID_H8 *_child[NCHILDREN];

 private: // object auxiliary ///////////////////////////////////////

  void eval_ns (GCELL_SOLID_H8 *child, EVALPT *evalpt, double xi, double eta, double theta,
