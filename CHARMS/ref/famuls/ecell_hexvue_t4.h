...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_HEXVUE_T4_H
# define ECELL_HEXVUE_T4_H

#include "ecell_hexvue.h"
#include "gcell_solid_t4.h"

template <int NUM_COMPONENTS>
class ECELL_HEXVUE_T4 : public ECELL_HEXVUE<NUM_COMPONENTS> {
  ...
  */
  void write (ckit_iobuf_t IOB,
              ...
              FIELD<NUM_COMPONENTS> *field)
    {
      ...
      write_hexvue_t4_compressed (IOB, x, v);
    }
...
# undef max
  ...
  int write_hexvue_t4_compressed (ckit_iobuf_t IOB,
                                  POINT p[4],
...
make (GCELL *gcell)
{
  return (new ECELL_HEXVUE_T4<NUM_COMPONENTS> (gcell));
}

template <int NUM_COMPONENTS>
bool
ECELL_HEXVUE_T4<NUM_COMPONENTS>::register_make_func ()
{
