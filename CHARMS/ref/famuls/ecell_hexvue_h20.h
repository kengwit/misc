...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_HEXVUE_H20_H
# define ECELL_HEXVUE_H20_H

#include "ecell_hexvue.h"
#include "gcell_solid_h20.h"

template <int NUM_COMPONENTS>
class ECELL_HEXVUE_H20 : public ECELL_HEXVUE<NUM_COMPONENTS> {
 ...
 public: // class functions  ////////////////////////////////////////
  ...
  virtual void write (ckit_iobuf_t IOB,
              ...
              FIELD<NUM_COMPONENTS> *field)
    {
      ...
      write_hexvue_hex_compressed (IOB, x, v);
    }
...
make (GCELL *gcell)
{
  return (new ECELL_HEXVUE_H20<NUM_COMPONENTS> (gcell));
}

template <int NUM_COMPONENTS>
bool
ECELL_HEXVUE_H20<NUM_COMPONENTS>::register_make_func ()
{
  return ECELL_HEXVUE<NUM_COMPONENTS>::register_make_func (make,
                                                           string (GCELL_SOLID_H20::TYPE_NAME),
                                                           string ("default"));
}
