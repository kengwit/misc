...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef GCELL_SURF_T3_H
# define GCELL_SURF_T3_H

#include "fen.h"
#include "gcell.h"

class GCELL_SURF_T3 : public GCELL {
 ...
 public: // class members
  ...
  static const sizet NDETAILFENS = 3; // mid-edge nodes

  static const int edge_vert_neigh[3][2];
  static const int vert_edge_neigh[3][2];
...
//  std::set <FEN *> complete_refinement_set (FEN *fen_of_bfun_to_refine);
  ...
  */ 
  ...
  GraphicObj *make_elixir_obj () {
    ...
    GraphicObj *go = CreateTriangle3D (points);
    return go;
  }
 ...
 private: // object data ////////////////////////////////////////////
  ...
  CONN_SURF_3    _conn;
  GCELL_SURF_T3 *_parent;
  GCELL_SURF_T3 *_child[NCHILDREN];

 private: // object auxiliary ///////////////////////////////////////

  void eval_ns (GCELL_SURF_T3 *child, EVALPT *evalpt, 
