...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_WAVE_ISO_H8_H
# define ECELL_WAVE_ISO_H8_H
...
class ECELL_WAVE_ISO_H8 : public ECELL_WAVE {
 ...
 public: // object functions ////////////////////////////////////////
  ...
  FIXED_VECTOR<3> momentum(){ FIXED_VECTOR<3> zero(0); return zero; }; 
