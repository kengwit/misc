...
--------------------------------------------------------------------------*/
#include "famuls.h"
#include "ecell_wave_traction_l2.h"
#include "evalpt.h"
#include "square_fixed_matrix.h"
#include "gcell_line_l2.h"
#include "proto_wave.h"

const char ECELL_WAVE_TRACTION_L2::_type_name[] = "wave_traction_l2";

ECELL_WAVE_TRACTION_L2::ECELL_WAVE_TRACTION_L2 (GCELL *gcell)
...
bool 
ECELL_WAVE_TRACTION_L2::assem_tractions_load ()
{
...
make (GCELL *gcell)
{
  return (new ECELL_WAVE_TRACTION_L2 (gcell));
}

bool
ECELL_WAVE_TRACTION_L2::register_make_func ()
{
  return ECELL_WAVE::register_make_func (make, string (GCELL_LINE_L2::TYPE_NAME),
                                               string (_type_name));
}
