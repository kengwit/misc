...
const char ECELL_ERREST_WAVE_H8::TYPE_NAME[] = "errest_wave_h8";

ECELL_ERREST_WAVE_H8::ECELL_ERREST_WAVE_H8 (GCELL *gcell)
...
void
ECELL_ERREST_WAVE_H8::assemble_error (FIELD_VECTOR *u,
...
make (GCELL *gcell)
{
  return (new ECELL_ERREST_WAVE_H8 (gcell));
}
...
void
ECELL_ERREST_WAVE_H8::attach (class PROTO_ERREST<3> *proto, string ggpath)
{
  ...
  //cerr << "done in ECELL_ERREST_WAVE_H8::attach" << endl;
}
