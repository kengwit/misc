...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_STEADY_DIFFUSION_T4_H
# define ECELL_STEADY_DIFFUSION_T4_H
...
class ECELL_STEADY_DIFFUSION_T4 : public ECELL_STEADY_DIFFUSION {
 ...
 public: // object functions ////////////////////////////////////////
  ...
  ECELL_STEADY_DIFFUSION_T4 (GCELL *gcell);
