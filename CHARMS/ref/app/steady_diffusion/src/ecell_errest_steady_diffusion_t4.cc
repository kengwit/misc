...
const char ECELL_ERREST_STEADY_DIFFUSION_T4::TYPE_NAME[] = "errest_steady_diffusion_t4";

ECELL_ERREST_STEADY_DIFFUSION_T4::ECELL_ERREST_STEADY_DIFFUSION_T4 (GCELL *gcell)
  : ECELL_ERREST<1>::ECELL_ERREST (gcell) 
{
}

void
ECELL_ERREST_STEADY_DIFFUSION_T4::assemble_error (FIELD_SCALAR *field,
...
make (GCELL *gcell)
{
  return (new ECELL_ERREST_STEADY_DIFFUSION_T4 (gcell));
}

bool
ECELL_ERREST_STEADY_DIFFUSION_T4::register_make_func ()
{
  return ECELL_ERREST<1>::register_make_func (make, string (GCELL_SOLID_T4::TYPE_NAME), string ("default"));
}
