...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_STEADY_DIFFUSION_T6_H
# define ECELL_STEADY_DIFFUSION_T6_H
...
class ECELL_STEADY_DIFFUSION_T6 : public ECELL_STEADY_DIFFUSION {
 ...
 public: // object functions ////////////////////////////////////////
  ...
  ECELL_STEADY_DIFFUSION_T6 (GCELL *gcell);
