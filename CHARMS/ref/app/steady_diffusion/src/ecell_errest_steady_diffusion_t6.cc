...
const char ECELL_ERREST_STEADY_DIFFUSION_T6::TYPE_NAME[] = "errest_steady_diffusion_t6";

ECELL_ERREST_STEADY_DIFFUSION_T6::ECELL_ERREST_STEADY_DIFFUSION_T6 (GCELL *gcell)
  : ECELL_ERREST<1>::ECELL_ERREST (gcell) 
{
}

void
ECELL_ERREST_STEADY_DIFFUSION_T6::assemble_error (FIELD_SCALAR *field,
...
make (GCELL *gcell)
{
  return (new ECELL_ERREST_STEADY_DIFFUSION_T6 (gcell));
}

bool
ECELL_ERREST_STEADY_DIFFUSION_T6::register_make_func ()
{
  return ECELL_ERREST<1>::register_make_func (make, string (GCELL_SURF_T6::TYPE_NAME), string ("default"));
}
