...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_STEADY_DIFFUSION_L2_H
# define ECELL_STEADY_DIFFUSION_L2_H
...
class ECELL_STEADY_DIFFUSION_L2 : public ECELL_STEADY_DIFFUSION {
 ...
 public: // object functions ////////////////////////////////////////
  ...
  /**
   */
  ECELL_STEADY_DIFFUSION_L2 (GCELL *gcell);
