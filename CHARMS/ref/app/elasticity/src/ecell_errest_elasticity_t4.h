...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_ERREST_ELASTICITY_T4_H
# define ECELL_ERREST_ELASTICITY_T4_H
...
class ECELL_ERREST_ELASTICITY_T4 : public ECELL_ERREST<3> {
 ...
 public: // object functions ////////////////////////////////////////
  ...
  /**
   */
  ECELL_ERREST_ELASTICITY_T4 (GCELL *gcell);
