...
const char ECELL_ERREST_ELASTICITY_H8::TYPE_NAME[] = "errest_elasticity_h8";

ECELL_ERREST_ELASTICITY_H8::ECELL_ERREST_ELASTICITY_H8 (GCELL *gcell)
...
void
ECELL_ERREST_ELASTICITY_H8::assemble_error (FIELD_VECTOR *u,
                                 FIELD_VECTOR *geometry, class PROTO_ERREST<3> *proto)
{
  ...
  { // one-point quadrature
    ...
    double vol = 2 * evalpt.detJ (); // one-point quadrature
...
make (GCELL *gcell)
{
  return (new ECELL_ERREST_ELASTICITY_H8 (gcell));
}

bool
ECELL_ERREST_ELASTICITY_H8::register_make_func ()
{
  return ECELL_ERREST<3>::register_make_func (make, string (GCELL_SOLID_H8::TYPE_NAME), string ("default"));
}


void
ECELL_ERREST_ELASTICITY_H8::attach (class PROTO_ERREST<3> *proto, string ggpath)
{
  ...
  //cerr << "done in ECELL_ERREST_ELASTICITY_H8::attach" << endl;
}
