...
const char ECELL_ELASTICITY_H8::_type_name[] = "elasticity_h8";

ECELL_ELASTICITY_H8::ECELL_ELASTICITY_H8 (GCELL *gcell)
...
bool ECELL_ELASTICITY_H8::assemble_stiffness_matrix (FIELD_VECTOR *u,
...
bool ECELL_ELASTICITY_H8::assemble_tractions_load (FIELD_VECTOR *u,
                                                      LES *les, FIELD_VECTOR *geometry)
{
...
bool ECELL_ELASTICITY_H8::assemble_body_load (FIELD_VECTOR *u,
                                                      LES *les, FIELD_VECTOR *geometry)
{
...
bool ECELL_ELASTICITY_H8::assemble_prescribed_u_load (FIELD_VECTOR *u,
                                                      LES *les, FIELD_VECTOR *geometry)
{
  GAUSS_3d_integration_rule_t *gr = gauss_rule_3d (2);
  vector <DOFMAPPER_VECTOR *> dv = dofmappers ();
...
make (GCELL *gcell)
{
  return (new ECELL_ELASTICITY_H8 (gcell));
}

bool
ECELL_ELASTICITY_H8::register_make_func ()
{
  return ECELL_ELASTICITY::register_make_func (make, string (GCELL_SOLID_H8::TYPE_NAME), string ("default"));
}
