...
--                                                                        --
--------------------------------------------------------------------------*/
#ifndef ECELL_ELASTICITY_H8_BBAR_H
# define ECELL_ELASTICITY_H8_BBAR_H
...
class ECELL_ELASTICITY_H8_BBAR : public ECELL_ELASTICITY {
 ...
 public: // object functions ////////////////////////////////////////
  ...
  ECELL_ELASTICITY_H8_BBAR (GCELL *gcell);
