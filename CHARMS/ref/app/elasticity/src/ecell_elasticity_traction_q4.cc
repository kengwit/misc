...
const char ECELL_ELASTICITY_TRACTION_Q4::_type_name[] = "elasticity_traction_q4";

ECELL_ELASTICITY_TRACTION_Q4::ECELL_ELASTICITY_TRACTION_Q4 (GCELL *gcell)
  : ECELL_ELASTICITY::ECELL_ELASTICITY (gcell)
{
}


bool ECELL_ELASTICITY_TRACTION_Q4::assemble_stiffness_matrix (FIELD_VECTOR *u,
...
bool ECELL_ELASTICITY_TRACTION_Q4::assemble_tractions_load (FIELD_VECTOR *u,
                                                      LES *les, FIELD_VECTOR *geometry)
{
...
make (GCELL *gcell)
{
  return (new ECELL_ELASTICITY_TRACTION_Q4 (gcell));
}

bool
ECELL_ELASTICITY_TRACTION_Q4::register_make_func ()
{
  return ECELL_ELASTICITY::register_make_func (make, string (GCELL_SURF_Q4::TYPE_NAME),
                                               string (_type_name));
}

bool ECELL_ELASTICITY_TRACTION_Q4::assemble_body_load (FIELD_VECTOR *u,
                                                      LES *les, FIELD_VECTOR *geometry)
{
  return true;
}

bool ECELL_ELASTICITY_TRACTION_Q4::assemble_prescribed_u_load (FIELD_VECTOR *u,
                                                      LES *les, FIELD_VECTOR *geometry)
{
  return true;
}
