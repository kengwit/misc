...
const char ECELL_ERREST_ELASTICITY_T4::TYPE_NAME[] = "errest_elasticity_t4";

ECELL_ERREST_ELASTICITY_T4::ECELL_ERREST_ELASTICITY_T4 (GCELL *gcell)
...
void
ECELL_ERREST_ELASTICITY_T4::assemble_error (FIELD_VECTOR *u,
...
make (GCELL *gcell)
{
  return (new ECELL_ERREST_ELASTICITY_T4 (gcell));
}
...
void
ECELL_ERREST_ELASTICITY_T4::attach (class PROTO_ERREST<3> *proto, string ggpath)
{
  ...
  //cerr << "done in ECELL_ERREST_ELASTICITY_T4::attach" << endl;
}
